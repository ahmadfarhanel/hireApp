...
const { createHireAccount, getAllData, getAccountById, deleteAccount, updateAccount } = require('../controllers/accountController')
...
const { createHire, getDataHireById, updateDataHireById, deleteDataHireById } = require('../controllers/hireController')
