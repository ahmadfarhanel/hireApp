...
const { getAllEngineer, getDataEngineerById, updateEngineer, searchEngineer, getFilterEngineer, getDataEngineerByAccountId, updatePatchEngineer } = require('../controllers/engineerController')
...
router.patch('/engineer/:engineerId', uploadImage, updatePatchEngineer)
